...
def clamp_func_wrapper_rank_1(in0: Union[torch.Tensor, StridedBuffer], val0, val1, /, *, out0: Union[torch.Tensor, StridedBuffer]): 
    """Generated wrapper function with Pointwise: StridedBuffer, scalar, scalar, StridedBuffer(a1!) -> StridedBuffer(a1!)"""
...
@libentry()
@triton.jit(do_not_specialize=['val0', 'val1'])
def clamp_func_kernel_rank_1(
