...
def tanh_kernel_wrapper_rank_1(in0: Union[torch.Tensor, StridedBuffer], /, *, out0: Union[torch.Tensor, StridedBuffer]): 
    ...
    with torch_device_fn.device(in0.device.index):
        tanh_kernel_kernel_rank_1[grid](
            in0, out0,
