...
@triton.jit
def log_softmax_kernel(output_ptr, input_ptr, M, N, K, BLOCK_M: tl.constexpr, BLOCK_N: tl.constexpr):
...
def log_softmax_backward(grad_output, output, dim, input_dtype):
    ...
    with torch_device_fn.device(in_grad.device):
        log_softmax_backward_kernel[grid](output, grad_output, in_grad, M, N, K)
    return in_grad
