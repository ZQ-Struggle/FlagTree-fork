...
def where_inner_wrapper_rank_1(in0: Union[torch.Tensor, StridedBuffer], in1: Union[torch.Tensor, StridedBuffer], in2: Union[torch.Tensor, StridedBuffer], /, *, out0: Union[torch.Tensor, StridedBuffer]): 
    """Generated wrapper function with Pointwise: StridedBuffer, StridedBuffer, StridedBuffer, StridedBuffer(a1!) -> StridedBuffer(a1!)"""
    ...
    if num_tasks == 0:
        return out0
    tile_sizes = heuristics_for_tile_size(380, *shape)
    ...
    with torch_device_fn.device(in0.device.index):
        where_inner_kernel_rank_1[grid](
            in0, in1, in2, out0,
