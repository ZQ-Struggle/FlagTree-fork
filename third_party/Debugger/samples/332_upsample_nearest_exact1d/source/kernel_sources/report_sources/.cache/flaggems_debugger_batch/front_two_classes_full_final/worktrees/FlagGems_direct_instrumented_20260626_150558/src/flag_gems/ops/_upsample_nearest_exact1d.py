...
@triton.jit
def _upsample_nearest_exact1d_kernel(in_ptr, out_ptr, N, C, IW, OW, sN_in, sC_in, sW_in, sN_out, sC_out, sW_out, use_scales: tl.constexpr, scale_w, BLOCK_W: tl.constexpr):
...
def _launch_upsample_nearest_exact1d_kernel(input, out, output_size=None, scale=None):
    ...
    _upsample_nearest_exact1d_kernel[grid](input, out, N, C, IW, OW, sN_in, sC_in, sW_in, sN_out, sC_out, sW_out, use_scales=use_scales, scale_w=scale_w, BLOCK_W=BLOCK_W)
    return out
