...
def silu_forward_wrapper_rank_1(in0: Union[torch.Tensor, StridedBuffer], /, *, out0: Union[torch.Tensor, StridedBuffer]): 
    ...
    with torch_device_fn.device(in0.device.index):
        silu_forward_kernel_rank_1[grid](
            in0, out0,
...
@libentry()
@triton.jit
def silu_forward_kernel_rank_1(
