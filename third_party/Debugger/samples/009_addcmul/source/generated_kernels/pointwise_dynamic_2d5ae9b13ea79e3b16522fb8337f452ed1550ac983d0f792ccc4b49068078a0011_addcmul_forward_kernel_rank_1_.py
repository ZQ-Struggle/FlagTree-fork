...
def addcmul_forward_wrapper_rank_1(in0: Union[torch.Tensor, StridedBuffer], in1: Union[torch.Tensor, StridedBuffer], in2: Union[torch.Tensor, StridedBuffer], val0, /, *, out0: Union[torch.Tensor, StridedBuffer]): 
    ...
    with torch_device_fn.device(in0.device.index):
        addcmul_forward_kernel_rank_1[grid](
...
def addcmul_forward_kernel_rank_1(
    ...
    if one_tile_per_cta: # monolitic kernel style
        ...
        # compute
        out0 = addcmul_forward(in0, in1, in2, val0)
