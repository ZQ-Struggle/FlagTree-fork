...
@triton.jit
def pixel_unshuffle_kernel(in_ptr, out_ptr, n_elements, N, C, H, W, R, C_out, H_out, W_out, BLOCK_SIZE: tl.constexpr):
...
def _launch_pixel_unshuffle_kernel(inp: torch.Tensor, downscale_factor: int, out: torch.Tensor):
    ...
    with torch_device_fn.device(inp.device):
        pixel_unshuffle_kernel[grid](inp, out, n_elements, N, C, H, W, r, C_out, H_out, W_out, BLOCK_SIZE=BLOCK_SIZE)
