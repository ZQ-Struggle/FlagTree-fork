...
def logical_not_func_wrapper_rank_1(in0: Union[torch.Tensor, StridedBuffer], /, *, out0: Union[torch.Tensor, StridedBuffer]): 
    ...
    with torch_device_fn.device(in0.device.index):
        logical_not_func_kernel_rank_1[grid](
            in0, out0,
...
@libentry()
@triton.jit
def logical_not_func_kernel_rank_1(
